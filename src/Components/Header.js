    ...
    return (
      ...
      <div className="row banner">
         <div className="banner-text">
            ...
            <h3>Jeg studerer <span>industriell økonomi og teknologiledelse</span> på NTNU. Ved siden av studiene er jeg <span>strategikonsulent i Junior Consulting</span>.</h3>
            <hr />
            <ul className="social">
               {networks}
            </ul>
